...
const checkModuleAccess = (requiredPlan) => {
    return (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
        ...
        const user = req.user;
        try {
            const org = yield Organization_1.Organization.findById(user.organization);
            if (!org)
                return res.status(404).json({ msg: 'Organization not found' });
            const plans = ['basic', 'standard', 'pro'];
            const orgPlan = (_a = org === null || org === void 0 ? void 0 : org.subscriptionPlan) !== null && _a !== void 0 ? _a : '';
